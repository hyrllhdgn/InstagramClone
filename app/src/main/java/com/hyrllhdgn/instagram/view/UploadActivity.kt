...
import com.hyrllhdgn.instagram.databinding.ActivityUploadBinding
...
class UploadActivity : AppCompatActivity() {
    ...
    //Upload sayfasında resmi seçtiğimiz butona ait komutlar:
    ...
    //Upload sayfasında resmi seçip, yazısını yazdıkdan sonra paylaş dediğimiz butona ait komutlar:
    ...
    //içeride yapamadıgımız için onCreate altında yapacagız. Onedenle bir fonk. oluşturalım:
